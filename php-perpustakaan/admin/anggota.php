...
<link rel="stylesheet" href="../img/cssform.css">
 ...
 <div class="main">
   <b><i class="fa fa-id-card"></i> Member Information</b><a href="#" rel="tooltip" title="Add New Member"><button type="button" name="button" class="btn btn-secondary" style="margin-left:67%" onclick="document.getElementById('id01').style.display='block'"><i class="fa fa-fw fa-plus"></i></button>
     ...
     <form class="modal-content animate" action="anggota_proses.php?prabowo=tambah" method="post">
       ...
       <div class="container1">
         <div class="alert alert-danger">
           Member ID as username and password 123
         </div>
         ...
         <input type="text" placeholder="Mobile Phone" name="no_telp" required>
    ...
    <table class="table table-hover">
      ...
      <tbody>
        <tr>
          ...
          <td>
            <a rel="tooltip" title="Edit" href="anggota_edit.php?agung=<?php echo $data['nis']; ?>">
