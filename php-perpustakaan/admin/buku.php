...
include'sidebar.php';
 ...
 <div class="main">
   <b><i class="fa fa-Book"></i>Books Information</b><a href="#" rel="tooltip" title="Add Book"><button type="button" name="button" class="btn btn-secondary" style="margin-left:73%" onclick="document.getElementById('id01').style.display='block'" style="width:auto;"><i class="fa fa-fw fa-plus"></i></button>
   ...
   <div id="id01" class="modal">
     ...
     <form class="modal-content animate" action="buku_proses.php?prabowo=tambah" method="post">
       ...
       <div class="container1">
         ...
         <input type="text" placeholder="Add Books Title" name="judul" required>

         <input type="text" placeholder="Add Books Author" name="pengarang" required>
         ...
         <input type="text" placeholder="Add Books Stock" name="stok" required>

         <input type="text" placeholder="Add Books Year" name="tahun" required>

         <select name="status" >
           <option>All</option>
           <option>New Book</option>
           <option>Old Book</option>
           <option>Broken Book</option>
    ...
    <table class="table table-hover">
      ...
      <tbody>
        <tr>
          ...
          <td>
            <a rel="tooltip" title="Borrow" href="pinjam_tambah.php?agung=<?php echo $data['kode_buku']; ?>">
          ...
          <td>
            <a rel="tooltip" title="Delete" href="buku_proses.php?prabowo=hapus&app=<?php echo $data['kode_buku']; ?>" onclick="return confirm('apakah anda yakin?')">
